# ADR-0001: PyTorch Instance Segmentation Project
...
and `pytorch-image-segmentation-lab`. Its initial implementation uses Penn-Fudan
...
instance visualization. Full reference training runs on Kaggle GPU:
...
6. add usage documentation and extension examples;
7. generate and validate the self-contained Kaggle runner, complete the full GPU
   run, and publish auditable recorded-run artifacts without the large checkpoint.
